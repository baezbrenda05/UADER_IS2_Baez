class CalculadorImpuestos:
    ...
    def calcular(self, base_imponible):
        ...
        print(f"  IVA (21%): {iva}")
        print(f"  IIBB (5%): {iibb}")
        print(f"  Contribuciones municipales (1.2%): {contrib_municipal}")
        print(f"  Total impuestos: {total}")
        return total
...
print(f"Impuestos sobre 10000:")
calc1.calcular(10000)
print(f"Impuestos sobre 2500:")
calc2.calcular(2500)